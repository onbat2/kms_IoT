...
#include <memory>
#include "../../../kms-Dashboard/hdr/Plugin/DataSource.h"
...
QT_MOC_LITERAL(7, 55, 26), // "QtCharts::QAbstractSeries*"
QT_MOC_LITERAL(8, 82, 6) // "series"

    },
    "DataSource\0generateData\0\0type\0rowCount\0"
    "colCount\0update\0QtCharts::QAbstractSeries*\0"
    "series"
};
...
void DataSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->update((*reinterpret_cast< QtCharts::QAbstractSeries*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 1:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< QtCharts::QAbstractSeries* >(); break;
            }
            break;
        }
    }
